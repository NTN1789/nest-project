...
export class UsersService {
  ...
  async findOne(email: string): Promise<User> {
    return await this.userModel
      ...
      .populate('tasks', 'name', this.taskModel) // o populate está  entrando dentro do documento do  usuario , ta olhando o field de Task e indo no usuario , ele vai relacionar tudo que tiver no id , muito bom para isso 
        //ta olhando os dois ids que foram adicionado 
      .exec();
  }
